...
export default function LeadershipCard({ leader, ctaText }: { leader: ManagementProfile, ctaText: string }) {
	...
	return (
		<div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col p-6 transition-all duration-300 hover:shadow-xl w-full h-full min-h-[420px]">
			...
			<div className="flex flex-col flex-grow text-center">
				...
				<p className="text-gray-600 text-sm leading-relaxed flex-grow">{leader.summary}</p>
			</div>
