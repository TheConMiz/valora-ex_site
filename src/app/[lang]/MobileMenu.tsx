...
interface MobileMenuProps {
	...
	navLinks: NavLink[];
	lang: string;
	ctaText: string; // <-- Added to accept localized CTA text
}

export default function MobileMenu({ isOpen, onClose, navLinks, lang, ctaText }: MobileMenuProps) {
	...
	return (
		<div
			className="lg:hidden border-b border-gray-200 bg-white absolute w-full z-40 shadow-xl"
			id="mobile-menu"
			ref={menuRef}
			role="dialog"
			aria-modal="true"
